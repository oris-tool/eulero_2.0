package org.oristool.eulero.evaluation.heuristic.iterative;
...
public abstract class AnalysisHeuristicStrategy {
    ...
    public AnalysisHeuristicStrategy(String heuristicName, BigInteger CThreshold, BigInteger SThreshold, Approximator approximator){
    ...
    public abstract double[] analyze(Activity model, BigDecimal timeLimit, BigDecimal step, BigDecimal error, String verbose, String plotIntermediate, String tabSpaceChars);
    ...
    public double[] InnerBlockReplicationAnalysis(Activity model, BigDecimal timeLimit, BigDecimal step, BigDecimal forwardReductionFactor, BigDecimal error, String tabSpaceChars){
        ...
        sortedInnerBlocks.sort(Comparator.comparing(Activity::C).thenComparing(Activity::S));
