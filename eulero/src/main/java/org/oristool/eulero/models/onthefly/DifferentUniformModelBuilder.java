...
public class DifferentUniformModelBuilder extends ModelBuilder {
    ...
    public Activity buildModelForAnalysis_Heuristic1(BigDecimal timeBound, BigDecimal timeTick) {
        ...
        Analytical r_0_bis = new Analytical("RBis", StochasticTransitionFeature.newUniformInstance(BigDecimal.valueOf(features.get((counter) % featuresSize).get("low")), BigDecimal.valueOf(features.get((counter++) % featuresSize).get("upp"))));
        ...
        DAG tu_0 = DAG.forkJoin("TU",
                new Analytical("U", StochasticTransitionFeature.newUniformInstance(BigDecimal.valueOf(features.get((counter) % featuresSize).get("low")), BigDecimal.valueOf(features.get((counter++) % featuresSize).get("upp")))),
                DAG.sequence("T",
        ...
        DAG wx_0 = DAG.forkJoin("WX",
                new Analytical("W", StochasticTransitionFeature.newUniformInstance(BigDecimal.valueOf(features.get((counter) % featuresSize).get("low")), BigDecimal.valueOf(features.get((counter++) % featuresSize).get("upp")))),
                DAG.sequence("X",
        ...
        Analytical r_3_bis = new Analytical("R'''Bis", StochasticTransitionFeature.newUniformInstance(BigDecimal.valueOf(features.get((counter) % featuresSize).get("low")), BigDecimal.valueOf(features.get((counter++) % featuresSize).get("upp"))));
        ...
        Numerical oNumerical = Numerical.and(List.of(
                Numerical.seq(List.of(
                        Numerical.uniform("G'", BigDecimal.valueOf(features.get((counter) % featuresSize).get("low")), BigDecimal.valueOf(features.get((counter++) % featuresSize).get("upp")), timeTick),
                        Numerical.and(List.of(
                                Numerical.uniform("I'", BigDecimal.valueOf(features.get((counter) % featuresSize).get("low")), BigDecimal.valueOf(features.get((counter++) % featuresSize).get("upp")), timeTick),
                                Numerical.uniform("J'", BigDecimal.valueOf(features.get((counter) % featuresSize).get("low")), BigDecimal.valueOf(features.get((counter++) % featuresSize).get("upp")), timeTick))
                        ))
                ),
                Numerical.seq(List.of(
                        Numerical.uniform("K'", BigDecimal.valueOf(features.get((counter) % featuresSize).get("low")), BigDecimal.valueOf(features.get((counter++) % featuresSize).get("upp")), timeTick),
        ...
        Analytical fBis = new Analytical("FBis", StochasticTransitionFeature.newUniformInstance(BigDecimal.valueOf(features.get((counter) % featuresSize).get("low")), BigDecimal.valueOf(features.get((counter++) % featuresSize).get("upp"))));
    ...
    public Activity buildModelForAnalysis_Heuristic2(BigDecimal timeBound, BigDecimal timeTick) {
        ...
        Numerical tu_0 = Numerical.and(List.of(
                Numerical.uniform("U", BigDecimal.valueOf(features.get((counter) % featuresSize).get("low")), BigDecimal.valueOf(features.get((counter++) % featuresSize).get("upp")), timeTick),
                Numerical.seq(List.of(
                        Numerical.uniform("T1", BigDecimal.valueOf(features.get((counter) % featuresSize).get("low")), BigDecimal.valueOf(features.get((counter++) % featuresSize).get("upp")), timeTick),
                        Numerical.uniform("T2", BigDecimal.valueOf(features.get((counter) % featuresSize).get("low")), BigDecimal.valueOf(features.get((counter++) % featuresSize).get("upp")), timeTick)
                ))
        ));

        Numerical wx_0 = Numerical.and(List.of(
                Numerical.uniform("W", BigDecimal.valueOf(features.get((counter) % featuresSize).get("low")), BigDecimal.valueOf(features.get((counter++) % featuresSize).get("upp")), timeTick),
                Numerical.seq(List.of(
                        Numerical.uniform("X1", BigDecimal.valueOf(features.get((counter) % featuresSize).get("low")), BigDecimal.valueOf(features.get((counter++) % featuresSize).get("upp")), timeTick),
                        Numerical.uniform("X2", BigDecimal.valueOf(features.get((counter) % featuresSize).get("low")), BigDecimal.valueOf(features.get((counter++) % featuresSize).get("upp")), timeTick)
                ))
        ));
    ...
    public Activity buildModelForSimulation() {
        ...
        Repeat e = new Repeat("E", 0.15,
                DAG.sequence("L",
                        m, new Analytical("N", StochasticTransitionFeature.newUniformInstance(BigDecimal.valueOf(features.get((counter) % featuresSize).get("low")), BigDecimal.valueOf(features.get((counter++) % featuresSize).get("upp")))),
                        DAG.forkJoin("O",
                                DAG.sequence("E'",
                                        new Analytical("G'", StochasticTransitionFeature.newUniformInstance(BigDecimal.valueOf(features.get((counter) % featuresSize).get("low")), BigDecimal.valueOf(features.get((counter++) % featuresSize).get("upp")))),
                                        DAG.forkJoin("H'",
