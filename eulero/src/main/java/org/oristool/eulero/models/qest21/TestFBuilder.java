...
public class TestFBuilder extends ModelBuilder {
    public TestFBuilder(StochasticTransitionFeature feature) {
        super(feature);
    }

    public TestFBuilder(ArrayList<StochasticTransitionFeature> features, ArrayList<BigDecimal> weights) {
    ...
    public Activity buildModel() {
        ...
        Analytical v = new Analytical("V", features, weights);
        Xor s = new Xor("S",
                List.of(new Analytical("S1", features, weights), new Analytical("S2", features, weights)),
                List.of(0.7, 0.3)
        );
        Xor t = new Xor("T",
                List.of(new Analytical("T1", features, weights), new Analytical("T2", features, weights)),
                List.of(0.1, 0.9)
        );
