...
public class AnalysisHeuristic1 extends AnalysisHeuristicStrategy{
    public AnalysisHeuristic1(BigInteger CThreshold, BigInteger RThreshold, Approximator approximator, boolean verbose) {
        super("Heuristic 1", CThreshold, RThreshold, approximator, verbose);
    }
