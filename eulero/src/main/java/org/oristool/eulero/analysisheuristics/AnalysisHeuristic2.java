...
public class AnalysisHeuristic2 extends AnalysisHeuristicStrategy{
    public AnalysisHeuristic2(BigInteger CThreshold, BigInteger RThreshold, Approximator approximator, boolean verbose) {
        super("Heuristic 2", CThreshold, RThreshold, approximator, verbose);
    }
